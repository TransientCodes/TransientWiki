...
export default (() => {
  ...
  const Head: QuartzComponent = ({
    ...
    const iconPath = joinSegments(baseDir, "/1080_1.webp")

    const ogImageDefaultPath = `https://resources.transientcodes.de/material/icon/icon.png`
    // "static/social-images/slug-filename.md.webp" 
    const ogImageGeneratedPath = `https://resources.transientcodes.de/material/icon/icon.png`
    ...
    if (frontmatterImgUrl) {
      ogImagePath = `https://resources.transientcodes.de/material/icon/icon.png`
    }
