const n=`<div style="background-color: #333; padding: 15px; border-bottom: 3px solid #88ff55; margin-bottom: 20px;">
    <h1 style="color: #ffffff; margin: 0;">Erlaubte Mods</h1>
</div>



> Dies ist die offizielle Whitelist. Wenn's nicht hier steht, ist es erstmal nicht erlaubt. Gerne im Discord Nachfragen, wenns erlaubt ist, kommt es hier drauf.
...
Unsicher? Auf Discord melden.  

Name, Version, Link, Zweck. Wenn’s durchgeht, landet es hier.
